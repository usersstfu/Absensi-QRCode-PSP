...
<div>
  ...
  <div class="flex-1 basis-[20%] min-w-[200px] rounded-md bg-green-200 px-8 py-4 text-gray-800 dark:bg-green-900 dark:text-white dark:shadow-gray-700">
    <span class="text-2xl font-semibold md:text-3xl">Hadir: {{ $presentCount }}</span><br>
    <span>Terlambat: {{ $lateCount }}</span>
  </div>
  <div class="flex-1 basis-[20%] min-w-[200px] rounded-md bg-blue-200 px-8 py-4 text-gray-800 dark:bg-blue-900 dark:text-white dark:shadow-gray-700">
    <span class="text-2xl font-semibold md:text-3xl">Izin: {{ $excusedCount }}</span><br>
    <span>Izin/Cuti</span>
  </div>
  <div class="flex-1 basis-[20%] min-w-[200px] rounded-md bg-purple-200 px-8 py-4 text-gray-800 dark:bg-purple-900 dark:text-white dark:shadow-gray-700">
    <span class="text-2xl font-semibold md:text-3xl">Sakit: {{ $sickCount }}</span>
  </div>
  <div class="flex-1 basis-[20%] min-w-[200px] rounded-md bg-orange-200 px-8 py-4 text-gray-800 dark:bg-orange-900 dark:text-white dark:shadow-gray-700">
    <span class="text-2xl font-semibold md:text-3xl">Dinas: {{ $businessTripCount }}</span><br>
    <span>Perjalanan Dinas</span>
  </div>
  <div class="flex-1 basis-[20%] min-w-[200px] rounded-md bg-red-200 px-8 py-4 text-gray-800 dark:bg-red-900 dark:text-white dark:shadow-gray-700">
    <span class="text-2xl font-semibold md:text-3xl">Tidak Hadir: {{ $absentCount }}</span><br>
    <span>Tidak/Belum Hadir</span>
  </div>
</div>

  <div class="mt-5 mb-4 overflow-x-scroll">
