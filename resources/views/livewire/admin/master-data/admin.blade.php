    ...
    <x-dialog-modal wire:model="creating">
        ...
        <form wire:submit="create">
            <x-slot name="content">
                ...
                <div class="mt-4 flex flex-col gap-4 sm:flex-row sm:gap-3">
                    <x-label for="form.gender">{{ __('Gender') }}</x-label>
                    <x-select id="form.gender" wire:model="form.gender" class="mt-1 block w-full">
                ...
                <div class="mt-4">
                    <x-label for="form.division_id">Divisi</x-label>
                    <h4 class="text-red-500 font-semibold">Untuk Super Admin Tidak Perlu Isi Divisi</h4>
                    <x-select id="form.division_id" wire:model="form.division_id" class="mt-1 block w-full"
                        required="{{ $form->group === 'admin' }}">
