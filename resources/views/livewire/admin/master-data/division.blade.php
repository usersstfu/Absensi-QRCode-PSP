    ...
    <x-dialog-modal wire:model="creating">
        ...
        <form wire:submit="create">
            <x-slot name="content">
                ...
                <x-label for="timezone" class="mt-4">Zona Waktu</x-label>
                <select id="timezone" class="mt-1 block w-full" wire:model="timezone">
                ...
                @error('timezone')
                    <x-input-error for="timezone" class="mt-2" message="{{ $message }}" />
                @enderror
            </x-slot>
