<div>
                ...
                @php
                    ...
                    switch ($status) {
                        ...
                        case 'absent':
                            ...
                            case 'dinas':
            $shortStatus = 'D';
            $bgColor = 'bg-orange-200 dark:bg-orange-900 hover:bg-orange-300 dark:hover:bg-orange-700 border border-orange-600';
            $dinasCount++;
            break;
                        default:
                            $shortStatus = '-';
    ...
    <div>
        <h4 class="text-lg font-semibold md:text-xl">Dinas: {{ $dinasCount }}</h4>
    </div>
</div>
