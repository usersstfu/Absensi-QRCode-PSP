...
Route::get('/admin/barcodes/get-shifts', [BarcodeController::class, 'getShiftsByDivision'])
    ->name('admin.barcodes.get-shifts');
...
Route::post('/face-attendance/store', [FaceAttendanceController::class, 'store'])->name('face-attendance.store');
